...
Elm.Colors = Elm.Colors || {};
Elm.Colors.make = function (_elm) {
   "use strict";
   _elm.Colors = _elm.Colors || {};
   if (_elm.Colors.values) return _elm.Colors.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var elmGray = A3($Color.rgb,90,99,120);
   var elmOrange = A3($Color.rgb,239,165,0);
   var elmTurquoise = A3($Color.rgb,96,181,204);
   var elmGreen = A3($Color.rgb,141,215,55);
   return _elm.Colors.values = {_op: _op,elmGreen: elmGreen,elmTurquoise: elmTurquoise,elmOrange: elmOrange,elmGray: elmGray,red: red,white: white};
};
Elm.Model = Elm.Model || {};
Elm.Model.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var parallelogramPoints = _U.list([{ctor: "_Tuple2",_0: 0.25,_1: 0.25}
                                     ,{ctor: "_Tuple2",_0: -0.75,_1: 0.25}
                                     ,{ctor: "_Tuple2",_0: -0.25,_1: -0.25}
                                     ,{ctor: "_Tuple2",_0: 0.75,_1: -0.25}]);
   var squarePoints = _U.list([{ctor: "_Tuple2",_0: 0.5,_1: 0}
                              ,{ctor: "_Tuple2",_0: 0,_1: 0.5}
                              ,{ctor: "_Tuple2",_0: -0.5,_1: 0}
                              ,{ctor: "_Tuple2",_0: 0,_1: -0.5}]);
   var trianglePoints = _U.list([{ctor: "_Tuple2",_0: 0,_1: 0.5},{ctor: "_Tuple2",_0: -1,_1: -0.5},{ctor: "_Tuple2",_0: 1,_1: -0.5}]);
   var addPosition = F2(function (_p1,_p0) {    var _p2 = _p1;var _p3 = _p0;return {ctor: "_Tuple2",_0: _p2._0 + _p3._0,_1: _p2._1 + _p3._1};});
   var movePiece = F3(function (dPosition,dRotation,piece) {
      return _U.update(piece,{position: A2(addPosition,piece.position,dPosition),rotation: piece.rotation + $Basics.degrees(dRotation)});
   });
   var AnimationActive = function (a) {    return {ctor: "AnimationActive",_0: a};};
   var AnimationStarting = function (a) {    return {ctor: "AnimationStarting",_0: a};};
   var AnimationIdle = {ctor: "AnimationIdle"};
   var Model = F3(function (a,b,c) {    return {dimensions: a,tangram: b,animation: c};});
   var Tangram = F7(function (a,b,c,d,e,f,g) {
      return {bigTriangle1: a,bigTriangle2: b,mediumTriangle: c,smallTriangle1: d,smallTriangle2: e,square: f,parallelogram: g};
   });
   var Piece = F5(function (a,b,c,d,e) {    return {points: a,position: b,rotation: c,color: d,scale: e};});
   var elmTangram = A7(Tangram,
   A5(Piece,trianglePoints,{ctor: "_Tuple2",_0: 0,_1: -0.5},0,$Colors.elmTurquoise,1),
   A5(Piece,trianglePoints,{ctor: "_Tuple2",_0: -0.5,_1: 0},$Basics.degrees(-90),$Colors.elmGray,1),
   A5(Piece,trianglePoints,{ctor: "_Tuple2",_0: 0.75,_1: 0.75},$Basics.degrees(-45),$Colors.elmTurquoise,1 / $Basics.sqrt(2)),
   A5(Piece,trianglePoints,{ctor: "_Tuple2",_0: 0.75,_1: -0.5},$Basics.degrees(90),$Colors.elmOrange,0.5),
   A5(Piece,trianglePoints,{ctor: "_Tuple2",_0: 0,_1: 0.25},$Basics.degrees(180),$Colors.elmOrange,0.5),
   A5(Piece,squarePoints,{ctor: "_Tuple2",_0: 0.5,_1: 0},0,$Colors.elmGreen,1),
   A5(Piece,parallelogramPoints,{ctor: "_Tuple2",_0: -0.25,_1: 0.75},0,$Colors.elmGreen,1));
   var runnerTangram = _U.update(elmTangram,
   {bigTriangle1: A3(movePiece,{ctor: "_Tuple2",_0: 0,_1: 0.25},0,elmTangram.bigTriangle1)
   ,bigTriangle2: A3(movePiece,{ctor: "_Tuple2",_0: 1,_1: 0.25},-90,elmTangram.bigTriangle2)
   ,mediumTriangle: A3(movePiece,{ctor: "_Tuple2",_0: 0,_1: -1.75},0,elmTangram.mediumTriangle)
   ,smallTriangle1: A3(movePiece,{ctor: "_Tuple2",_0: -0.1,_1: -1.25},45,elmTangram.smallTriangle1)
   ,smallTriangle2: A3(movePiece,{ctor: "_Tuple2",_0: 1 - 2 * $Basics.sqrt(2),_1: -1.5},-135,elmTangram.smallTriangle2)
   ,square: A3(movePiece,{ctor: "_Tuple2",_0: 0,_1: 1.25},360,elmTangram.square)
   ,parallelogram: A3(movePiece,{ctor: "_Tuple2",_0: 0 - 1 / $Basics.sqrt(2),_1: -1.86},45,elmTangram.parallelogram)});
   var init = A3(Model,{ctor: "_Tuple2",_0: 200,_1: 200},elmTangram,AnimationIdle);
   return _elm.Model.values = {_op: _op
                              ...
                              ,elmTangram: elmTangram
                              ,addPosition: addPosition
                              ,movePiece: movePiece
                              ,runnerTangram: runnerTangram
                              ,init: init
                              ,trianglePoints: trianglePoints
                              ,squarePoints: squarePoints
                              ,parallelogramPoints: parallelogramPoints};
};
...
Elm.Update.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var modify = F4(function (basePiece,_p0,dRotation,fraction) {
      var _p1 = _p0;
      var ease = F3(function (from,to,fraction) {    return A6($Easing.ease,$Easing.easeInExpo,$Easing.$float,from,to,1,fraction);});
      var rotation$ = A3(ease,basePiece.rotation,basePiece.rotation + $Basics.degrees(dRotation),fraction);
      var _p2 = basePiece.position;
      var px = _p2._0;
      var py = _p2._1;
      var position$ = {ctor: "_Tuple2",_0: A3(ease,px,px + _p1._0,fraction),_1: A3(ease,py,py + _p1._1,fraction)};
      return _U.update(basePiece,{position: position$,rotation: rotation$});
   });
   var makePerson = F3(function (fraction,tangram,model) {
      var parallelogram$ = A4(modify,tangram.parallelogram,{ctor: "_Tuple2",_0: -0.7,_1: -1.85},45,fraction);
      var square$ = A4(modify,tangram.square,{ctor: "_Tuple2",_0: 0,_1: 1.25},360,fraction);
      var smTri2 = A4(modify,tangram.smallTriangle2,{ctor: "_Tuple2",_0: -1.75,_1: -1.5},-135,fraction);
      var smTri1 = A4(modify,tangram.smallTriangle1,{ctor: "_Tuple2",_0: 0,_1: -1.25},45,fraction);
      var mediumTriangle$ = A4(modify,tangram.mediumTriangle,{ctor: "_Tuple2",_0: 0,_1: -1.75},0,fraction);
      var bigTriangle2$ = A4(modify,tangram.bigTriangle2,{ctor: "_Tuple2",_0: 1,_1: 0.25},-90,fraction);
      var bigTriangle1$ = A4(modify,tangram.bigTriangle1,{ctor: "_Tuple2",_0: 0,_1: 0.25},0,fraction);
      var tangram$ = _U.update(tangram,
      ...
      return _U.update(model,{tangram: tangram$});
   });
   var moveOutBack = F3(function (_p4,fraction,_p3) {
      var _p5 = _p4;
      var _p6 = _p3;
      var fraction$ = _U.cmp(fraction,0.5) < 0 ? fraction : 1 - fraction;
      return {ctor: "_Tuple2",_0: _p6._0 + fraction$ * _p5._0,_1: _p6._1 + fraction$ * _p5._1};
   });
   var movePieceOutBack = F3(function (_p7,piece,fraction) {
      var _p8 = _p7;
      var position$ = A3(moveOutBack,{ctor: "_Tuple2",_0: _p8._0,_1: _p8._1},fraction,piece.position);
      return _U.update(piece,{position: position$});
   });
   var animate = F3(function (fraction,startTangram,model) {
      var tangram = model.tangram;
      var square = startTangram.square;
      var square$ = _U.update(square,{rotation: startTangram.square.rotation + fraction * $Basics.degrees(90)});
      var travel = 0.35;
      var mediumTriangle$ = A3(movePieceOutBack,{ctor: "_Tuple2",_0: travel,_1: travel},startTangram.mediumTriangle,fraction);
      var smallTriangle1$ = A3(movePieceOutBack,{ctor: "_Tuple2",_0: travel,_1: 0 - travel},startTangram.smallTriangle1,fraction);
      var bigTriangle1$ = A3(movePieceOutBack,{ctor: "_Tuple2",_0: 0 - travel,_1: 0 - travel},startTangram.bigTriangle1,fraction);
      var parallelogram$ = A3(movePieceOutBack,{ctor: "_Tuple2",_0: 0 - travel,_1: travel},startTangram.parallelogram,fraction);
      var smallTriangle2$ = A3(movePieceOutBack,{ctor: "_Tuple2",_0: 0 - travel,_1: travel},startTangram.smallTriangle2,fraction);
      var tangram$ = _U.update(tangram,
      {square: square$
      ,mediumTriangle: mediumTriangle$
   ...
   var update = F2(function (action,model) {
      var _p9 = action;
      switch (_p9.ctor)
      {case "UpdateDimensions": return {ctor: "_Tuple2",_0: _U.update(model,{dimensions: _p9._0}),_1: $Effects.none};
         case "Click": var _p10 = model.animation;
           if (_p10.ctor === "AnimationIdle") {
                 return {ctor: "_Tuple2",_0: _U.update(model,{animation: $Model.AnimationStarting(1000)}),_1: $Effects.tick(Tick)};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              }
         case "Tick": var _p13 = _p9._0;
           var _p11 = model.animation;
           switch (_p11.ctor)
           {case "AnimationIdle": return A2($Debug.log,"error: got Tick while idle",{ctor: "_Tuple2",_0: model,_1: $Effects.none});
              case "AnimationStarting": var animation = $Model.AnimationActive({duration: _p11._0,startTime: _p13,startTangram: model.tangram});
                return {ctor: "_Tuple2",_0: _U.update(model,{animation: animation}),_1: $Effects.tick(Tick)};
              default: var _p12 = _p11._0.startTangram;
                var whichAnimation = makePerson;
                var fraction = (_p13 - _p11._0.startTime) / _p11._0.duration;
                return _U.cmp(fraction,1.0) > -1 ? {ctor: "_Tuple2"
                                                   ,_0: A3(whichAnimation,1,_p12,_U.update(model,{animation: $Model.AnimationIdle}))
                                                   ,_1: $Effects.none} : {ctor: "_Tuple2",_0: A3(whichAnimation,fraction,_p12,model),_1: $Effects.tick(Tick)};}
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var Click = {ctor: "Click"};
   var UpdateDimensions = function (a) {    return {ctor: "UpdateDimensions",_0: a};};
   var NoOp = {ctor: "NoOp"};
   return _elm.Update.values = {_op: _op,update: update,NoOp: NoOp,UpdateDimensions: UpdateDimensions,Click: Click,Tick: Tick};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   var _op = {};
   var loopPoints = function (pts) {
      var _p0 = pts;
      if (_p0.ctor === "::") {
            return A2($List.append,pts,_U.list([_p0._0]));
         } else {
            return _U.list([]);
         }
   };
   var scalePoints = F2(function (scaleFactor,pts) {
      var _p1 = pts;
      if (_p1.ctor === "::") {
            return A2($List._op["::"],{ctor: "_Tuple2",_0: _p1._0._0 * scaleFactor,_1: _p1._0._1 * scaleFactor},A2(scalePoints,scaleFactor,_p1._1));
         } else {
            return _U.list([]);
         }
   });
   var separation = 5.0e-2;
   var filledForm = F3(function (points,scaleFactor,color) {
      var scaledPoints = A2(scalePoints,scaleFactor,points);
      var linestyle = _U.update($Graphics$Collage.defaultLine,
      {width: separation,color: A3($Color.rgb,64,64,64),join: $Graphics$Collage.Smooth,cap: $Graphics$Collage.Round});
      return $Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,color,$Graphics$Collage.polygon(scaledPoints))
                                             ,A2($Graphics$Collage.traced,linestyle,$Graphics$Collage.path(loopPoints(scaledPoints)))]));
   });
   var scalingFactor = function (_p2) {    var _p3 = _p2;return A2($Basics.min,$Basics.toFloat(_p3._0),$Basics.toFloat(_p3._1)) / 4;};
   var formFromPiece = function (piece) {
      return A2($Graphics$Collage.rotate,piece.rotation,A2($Graphics$Collage.move,piece.position,A3(filledForm,piece.points,piece.scale,piece.color)));
   };
   var view = F2(function (address,model) {
      var _p4 = model.dimensions;
      var width = _p4._0;
      var height = _p4._1;
      var form = A2($Graphics$Collage.scale,
      scalingFactor(model.dimensions),
      $Graphics$Collage.group(_U.list([formFromPiece(model.tangram.bigTriangle1)
      ...
      return A2($Graphics$Input.clickable,A2($Signal.message,address,$Update.Click),A3($Graphics$Collage.collage,width,height,_U.list([form])));
   });
   return _elm.View.values = {_op: _op
                             ,view: view
                             ,formFromPiece: formFromPiece
...
Elm.Start.make = function (_elm) {
   ...
   var start = function (config) {
      ...
      return {output: A2($Signal.map,config.view(address),model)
             ,model: model
             ,tasks: A2($Signal.map,function (_p5) {    return A2($Effects.toTask,messages.address,$Basics.snd(_p5));},effectsAndModel)};
   };
   var App = F3(function (a,b,c) {    return {output: a,model: b,tasks: c};});
   var Config = F4(function (a,b,c,d) {    return {init: a,update: b,view: c,inputs: d};});
   return _elm.Start.values = {_op: _op,Config: Config,App: App,start: start};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var appStartMailbox = $Signal.mailbox({ctor: "_Tuple0"});
   var sendInitial = $Effects.task(A2($Task.map,$Basics.always($Update.NoOp),A2($Signal.send,appStartMailbox.address,{ctor: "_Tuple0"})));
   var dimensionSignal = A2($Signal.map,$Update.UpdateDimensions,$Window.dimensions);
   var firstResize = A2($Signal.sampleOn,appStartMailbox.signal,dimensionSignal);
   var app = $Start.start({init: {ctor: "_Tuple2",_0: $Model.init,_1: sendInitial}
                          ,update: $Update.update
                          ,view: $View.view
                          ,inputs: _U.list([firstResize,dimensionSignal])});
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   var main = app.output;
   return _elm.Main.values = {_op: _op
                             ,main: main
                             ,dimensionSignal: dimensionSignal
                             ,app: app
                             ,appStartMailbox: appStartMailbox
